      ...
      if (responseData['status'] == "success") {
        ...
        if (productdataCount.length > 0) {
          for (int i = 0; i < productdataCount.length; i++) {
            ...
            savedPrice += ( (double.parse(item.regularPrice) * int.parse(item.qty)) - (double.parse(item.price) * int.parse(item.qty)));
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              Container(
                                child: mProductList.length > 0 ? ListView.builder(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                Variables.itemCount == null ? "0 Items":"${Variables.itemCount} Items",
                style: TextStyle(
                  fontFamily: "Philosopher",
                  fontSize: 15,
                  color: Colors.white,
