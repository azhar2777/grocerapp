...
class _ItemShoppingCartState extends State<ItemShoppingCart> {
  ...
  void initState() {
    ...
    _productRegularTotal = (double.parse(item.regularPrice) * int.parse(item.qty));
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: IconButton(
                                ...
                                icon:
                                    Image.asset("images/ic_remove_cart.png"),
                                iconSize: 15,
                                ...
                                Row(
                                  children: [
                                    Container(
                                      ...
                                      child: IconButton(
                                        icon:
                                            Image.asset('images/ic_minus.png'),
                                        onPressed: () {
                                          DcrBtn();
                                        },
                                      ),
                                    ...
                                    Container(
                                      ...
                                      width: 50,
                                      child: IconButton(
                                        icon: Image.asset('images/ic_plus.png'),
                                        onPressed: () {
                                          IncrBtn();
                                        },
                                      ),
